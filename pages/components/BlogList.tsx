  ...
  return ( posts && 
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-0 md:space-x-10 lg:space-y-20 lg:grid-cols-2 xl:grid-cols-2 items-center justify-center flex-col">
      ...
      {posts.map((post) => (
        <div
          key={post._id}
          className="group cursor-pointer hover:scale-105  transition-all duration-[300ms] ease-in-out w-full rounded overflow-hidden shadow-lg  shadow-primary_dark hover:shadow-accent  bg-primary"
        >
          <Image
