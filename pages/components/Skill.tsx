  ...
  return (
    <div className="group relative flex flex-col items-center group">
      <Image
        ...
        height={0}
        sizes="100vw"
        className="p-5  object-contain w-28 h-28 md:w-32 md:h-32 filter group-hover:scale-125 drop-shadow-md shadow-accent group-hover:drop-shadow-2xl transition duration-300 ease-in-out"
      />
